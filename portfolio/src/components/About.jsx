        ...
        <>
            <div className='about-container bg-[#ff5500] text-white h-[50vh]'>
                ...
                <div className='flex flex-row justify-evenly items-center w-[75%] mx-auto p-8 text-montserrat'>
                    <h1 className='font-p text-[2.5em] font-extrabold' style={{ textDecorationColor: 'gold'}}>About</h1>
                ...
                {/* blob */}
                <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className='absolute w-[38%] top-[94%] z-0 left-[12%]'>
