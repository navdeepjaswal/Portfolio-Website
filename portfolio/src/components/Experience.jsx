...
export default function Experience() {
  return (
    <>
      <div className='experience-container bg-[#ff5500] text-white'>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 220"><path fill="#ff5500" fill-opacity="1" d="M0,96L40,101.3C80,107,160,117,240,128C320,139,400,149,480,144C560,139,640,117,720,96C800,75,880,53,960,53.3C1040,53,1120,75,1200,101.3C1280,128,1360,160,1400,176L1440,192L1440,0L1400,0C1360,0,1280,0,1200,0C1120,0,1040,0,960,0C880,0,800,0,720,0C640,0,560,0,480,0C400,0,320,0,240,0C160,0,80,0,40,0L0,0Z"></path></svg>
    </>
