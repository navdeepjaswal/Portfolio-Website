    ...
    <div className='work-experience-container '>
      ...
      <p className='font-t pb-2 text-[.8em] font-light'>Jan 2000 - Oct 2023 </p>
          <ul>
            ...
            <li className='font-t font-light xsm:font-extralight text-[.9em]'> <ChevronRightIcon/> Revamped Avid Prepaid and Nexscard marketing websites, improving UI/UX design for responsiveness, attractiveness, and user-friendliness.</li>
            <li className='font-t font-light xsm:font-extralight text-[.9em]'> <ChevronRightIcon/> Led UI enhancements for cardholder sites by translating Figma designs into code using Photoshop, React, and JavaScript.</li>
            <li className='font-t font-light xsm:font-extralight text-[.9em]'> <ChevronRightIcon/> Set up webhooks for Atomic APIs using AWS Lambda and SQS with Node JS.</li>
            <li className='font-t font-light xsm:font-extralight text-[.9em]'> <ChevronRightIcon/> Improved site-wide pages using microservices, enhancing modularity and scalability, and seamlessly integrating features while adhering to sound architectural principles</li>
            <li className='font-t font-light xsm:font-extralight text-[.9em]'> <ChevronRightIcon/> Collaborated closely with senior full-stack developers to learn best practices in modularity, scalability, and maintaining clean and efficient code.</li>
          </ul>
        </div>
    }
